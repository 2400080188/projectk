...
const FEATURE_DETAILS = {
  ...
  'transport': {
    ...
    icon: (
      <svg width="40" height="40" fill="none" viewBox="0 0 40 40">
        <rect x="9" y="14" width="22" height="10" rx="5" fill="#3689E6"/>
  ...
  'lighting': {
    ...
    icon: (
      <svg width="40" height="40" fill="none" viewBox="0 0 40 40">
        <circle cx="20" cy="20" r="18" stroke="#F3C600" strokeWidth="4"/>
        <path d="M20 12v8" stroke="#F3C600" strokeWidth="3" strokeLinecap="round"/>
  ...
  'water': {
    ...
    icon: (
      <svg width="40" height="40" fill="none" viewBox="0 0 40 40">
        <ellipse cx="20" cy="20" rx="16" ry="10" stroke="#26A69A" strokeWidth="3"/>
      ...
      <div className="app-landing" style={{ background: "#f7faff", minHeight: "100vh" }}>
        ...
        <section style={{
          ...
          <div className="feature-card">
            ...
            <div style={{ color: "#7687a0", margin: "10px 0" }}>CCTV surveillance and emergency response systems</div>
            <button className="link-btn" onClick={() => setFeature('security')}>Learn More</button>
          </div>
          <div className="feature-card">
            <BuildingIcon />
            <div className="feature-title">Smart Buildings</div>
            <div style={{ color: "#7687a0", margin: "10px 0" }}>Energy-efficient infrastructure with automated systems</div>
            <button className="link-btn" onClick={() => setFeature('buildings')}>Learn More</button>
          </div>
          <div className="feature-card">
            ...
            <div style={{ color: "#7687a0", margin: "10px 0" }}>Real-time bus tracking and metro services across the city</div>
            <button className="link-btn" onClick={() => setFeature('transport')}>Learn More</button>
          </div>
          <div className="feature-card">
            ...
            <div style={{ color: "#7687a0", margin: "10px 0" }}>Energy-efficient LED street lights with automated control</div>
            <button className="link-btn" onClick={() => setFeature('lighting')}>Learn More</button>
          </div>
          <div className="feature-card">
            ...
            <div style={{ color: "#7687a0", margin: "10px 0" }}>24/7 water supply monitoring and quality control systems</div>
            <button className="link-btn" onClick={() => setFeature('water')}>Learn More</button>
          </div>
          <div className="feature-card">
            <WifiIcon />
            <div className="feature-title">Free WiFi Zones</div>
            <div style={{ color: "#7687a0", margin: "10px 0" }}>Public WiFi hotspots in key areas and tourist locations</div>
            <button className="link-btn" onClick={() => setFeature('wifi')}>Learn More</button>
          </div>
        </section>
        <section style={{
          background: "#f4f8fd",
